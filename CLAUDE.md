...
└── timers/             # 定时器
    ...
    ├── GaussianRandomTimer.schema.yaml
    ├── PoissonRandomTimer.schema.yaml
...
- **jmeter/** - JMeter 核心技能，包含 46 个组件 schema 和 58 个参考文档
  - `SKILL.md` - 主技能定义
  - `references/functions/Functions.md` - JMeter 函数参考
