...
public class CreateJMeterElementTool extends AbstractJMeterElementTool {
    ...
    protected ToolResult executeInternal(Map<String, Object> parameters) {
        ...
        if (componentValidator != null) {
            org.gitee.jmeter.ai.agent.validation.ComponentSchema schema =
    ...
    private Map<String, Object> applyDefaultValues(String elementType, Map<String, Object> properties) {
        ...
        for (org.gitee.jmeter.ai.agent.validation.ComponentSchema.PropertyDefinition propDef :
            ...
            if (propDef.getType() == org.gitee.jmeter.ai.agent.validation.ComponentSchema.PropertyType.OBJECT
    ...
    private Map<String, Object> createNestedDefaults(
            org.gitee.jmeter.ai.agent.validation.ComponentSchema.PropertyDefinition propDef) {
        Map<String, Object> defaults = new java.util.HashMap<>();
        if (propDef.getNestedProperties() == null) {
            return defaults;
        }

        for (org.gitee.jmeter.ai.agent.validation.ComponentSchema.PropertyDefinition nestedDef :
            ...
            if (nestedDef.getType() == org.gitee.jmeter.ai.agent.validation.ComponentSchema.PropertyType.OBJECT
