...
public class TreeNavigationButtons {
    ...
    public TreeNavigationButtons() {
        try {
            // Load PNG icons
            ImageIcon upIcon = new ImageIcon(getClass().getResource("/org/gitee/jmeter/ai/icons/up.png"));
            ImageIcon downIcon = new ImageIcon(getClass().getResource("/org/gitee/jmeter/ai/icons/down.png"));
